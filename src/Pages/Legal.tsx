...
import { Building, Mail, Phone, FileText, Calendar } from 'lucide-react';
...
const Legal: React.FC = () => {
  useSEO({
    ...
    url: "https://foireauxcadeaux.anaisconcept.biz/mentions-legales"
  });
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 space-y-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <h2 className="text-2xl font-bold text-gray-900">2. Directrice de publication</h2>
              </div>
              <div className="text-gray-700">
                <p>La directrice de la publication du site web foireauxcadeaux.anaisconcept.biz est :</p>
                <div className="bg-gray-50 rounded-lg p-6 mt-4">
                  <p className="font-semibold text-gray-900">Madame Deladem Sodatonou</p>
                  <p className="text-sm mt-2">Gérante d'ANAÏS Concept</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="text-gray-700">
                <p className="mb-4">Le site web foireauxcadeaux.anaisconcept.biz est hébergé par :</p>
                <div className="bg-gray-50 rounded-lg p-6">
                  <p className="font-semibold text-gray-900 mb-2">OVH SAS.</p>
                  <div className="space-y-1 text-sm">
                    <p> 2 rue Kellermann</p>
                    <p>59100 Roubaix, France</p>
                    <p className="mt-2"><strong>Site web :</strong> <a href="https://www.ovhcloud.com/fr/" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:underline">ovhcloud.com</a></p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-4">
                <p>
                  L'ensemble du contenu présent sur le site foireauxcadeaux.anaisconcept.biz (textes, images, graphismes, logo, 
                  vidéos, architecture, icônes, sons, logiciels, etc.) est la propriété exclusive de ANAÏS Concept, 
                ...
                <p>
                  ...
                  différents éléments est strictement interdite sans l'accord exprès par écrit de ANAÏS Concept.
                </p>
                <p>
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-4">
                <p>
                  ANAÏS Concept accorde une grande importance à la protection des données personnelles de ses 
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-4">
                <p>
                  Le site foireauxcadeaux.anaisconcept.biz utilise des cookies pour améliorer l'expérience utilisateur, 
                  réaliser des statistiques de visite et proposer des contenus adaptés.
                </p>
                <p>
                  Lors de votre première visite, un bandeau d'information pourrait apparaître vous permettant d'accepter 
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li><strong>Cookies analytiques :</strong> Mesure d'audience (Google Analytics, Hubspot)</li>
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-4">
                <p>
                  ANAÏS Concept met tout en œuvre pour offrir aux utilisateurs des informations fiables et 
                ...
                <p>
                  ANAÏS Concept ne saurait être tenu responsable des erreurs, omissions, interruptions ou 
                  retards dans la mise à jour des informations, ni des dommages directs ou indirects résultant 
                  de l'utilisation du site.
                </p>
                <p>
                  Les liens hypertextes présents sur le site peuvent renvoyer vers des sites tiers. ANAÏS Concept 
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-4">
                <p>
                  ...
                  l'utilisation du site foireauxcadeaux.anaisconcept.biz sera soumis à la compétence exclusive des tribunaux 
                  de Lomé, Togo.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-4">
                <p>
                  ANAÏS Concept se réserve le droit de modifier les présentes mentions légales à tout moment. 
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <a href="mailto:info@foireauxcadeaux.anaisconcept.biz" className="text-gray-900 hover:underline">
                        info@foireauxcadeaux.anaisconcept.biz
                      </a>
                    </div>
                    <div className="flex items-center gap-3">
                      <Phone size={18} className="text-gray-600" />
                      <a href="tel:+22890123148" className="text-gray-900 hover:underline">
                        +228 90 12 31 48
                      </a>
                    </div>
